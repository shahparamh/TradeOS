...
def get_system_rules(db: Session = Depends(get_db)):
    ...
    default_values = {
        ...
        "min_profit_threshold_pct": {"type": "float", "numeric_value": 0.005, "desc": "Minimum take profit percentage threshold (e.g. 0.015 for 1.5%)"},
        ...
        "min_confidence": {"type": "float", "numeric_value": 45.0, "desc": "Minimum model confidence floor to enter trade (0-100)"},
        "max_stop_loss_distance": {"type": "float", "numeric_value": 0.07, "desc": "Maximum allowed stop loss distance (e.g. 0.07 for 7%)"},
        "min_risk_reward_ratio": {"type": "float", "numeric_value": 1.0, "desc": "Minimum risk-reward ratio allowed"},
